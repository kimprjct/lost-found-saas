...
@section('content')
    <div class="bg-white rounded-lg shadow p-6 max-w-xl">
        <form method="POST" action="{{ route('tenant.found-requests.store') }}" class="space-y-4">
            @csrf
            <div>
            ...
            <div>
                ...
                <input name="found_by" class="w-full border rounded px-3 py-2" value="{{ old('found_by') }}" required />
            ...
            <div>
                ...
                <input name="date_found" type="date" class="w-full border rounded px-3 py-2" value="{{ old('date_found') }}" />
            ...
            <div class="flex items-center space-x-2">
                ...
                <button class="px-4 py-2 rounded bg-blue-600 text-white">Submit Found Request</button>
            </div>
        </form>
    </div>
@endsection
